...
export async function POST(req) {
  ...
  const { display_name, install_dir, ports, admin_password, platform, owner_id, default_world_name } = body || {};
  ...
  const world = prov.createProfile({ display_name, install_dir, ports, admin_password, platform, owner_id, default_world_name });
