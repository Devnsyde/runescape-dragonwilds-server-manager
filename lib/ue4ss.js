...
function install(installDir, zipPath) {
  const w64 = win64Dir(installDir);
  if (!fs.existsSync(w64)) throw new Error("Server binaries folder not found (RSDragonwilds/Binaries/Win64). Point the world at a valid RSDragonwilds install first.");
