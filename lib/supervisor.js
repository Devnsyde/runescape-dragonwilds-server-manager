...
function recordDeath(worldId, death) {
  ...
  else if (death.killer) killerDisplay = palnames.displayName(death.killer);
  ...
  try {
    dbm.logDeath(worldId, { victim, cause: causeRaw, killer: killerDisplay || null, killerKind: kind || null, at: death.at });
  } catch {}
...
module.exports = {
  ...
  bundledDeathModDir, startDeathTail, stopDeathTail,
};
